          ...
          <div className="mb-12 lg:mb-16">
            <div className="flex flex-col lg:items-end lg:justify-between">
              ...
              <p className="text-gray-700 text-base leading-relaxed max-w-lg">
                Our team provides specialized industrial services that ensure safety, reliability,
                and long-term performance. We deliver professional maintenance, inspection, and
                repair solutions — even in hard-to-access areas.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 justify-center items-stretch w-full">
              ...
              <div className="p-8 lg:p-10 bg-white rounded-[40px] order-2 lg:order-1">
                ...
                <div className="space-y-5 lg:space-y-6 mb-8">
                  <div>
                    <h4 className="font-bold mb-2 text-lg">Access, Safety & Fall Protection</h4>
                    <p className="text-base max-w-lg font-medium">
                      Engineered access, fall protection, and confined space solutions for
                  ...
                  <div>
                    ...
                    <p className="text-base max-w-lg font-medium">
                      Inspections, maintenance, and repair services supporting long-term asset
                      performance.
                    </p>
                  </div>
                  <hr />
                  <div>
                    <h4 className="font-bold mb-2 text-lg">Specialized & High-Risk Operations</h4>
                    <p className="text-base max-w-lg font-medium">
                      Shutdowns, emergency response, rescue operations, and complex lifting tasks.
                    </p>
                  </div>
                </div>

                <Link to="/services/industrial-services">
                  <button className="w-full bg-[#d9f143] text-center hover:bg-[#d9f143]/90 text-gray-900 font-semibold py-4 px-6 rounded-xl flex items-center gap-4 justify-center transition-colors group">
                    <span className="text-sm">Explore Industrial Services</span>
                    <img src="/home/arrow_diagonal.svg" alt="Arrow Right" className="w-2 h-2" />
                  </button>
                </Link>
              </div>
            </div>
