    ...
    >
      <nav className="container mx-auto py-3.5 lg:py-6 px-6">
        <div className="relative flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center justify-center gap-8">
            ...
            <Link to="/contact">
              <Button
                size="lg"
                className="bg-[#c3d533] hover:bg-[#c3d533]/90 text-black font-semibold"
              >
                Contact Us
              </Button>
            </Link>
        ...
        {isMobileMenuOpen && (
          ...
          >
            {/* ===== TOP BAR ===== */}
            <div className="shrink-0 w-full bg-[#343434] py-3.5 px-6 flex justify-end">
            ...
            <div className="flex-1 overflow-y-auto px-6 pt-6 pb-10">
              ...
              <ul className="flex flex-col items-center gap-5 mb-10">
                <li>
                  <Link
                    ...
                    className={`text-lg font-medium transition-colors hover:text-[#c3d533] ${
                      location.pathname === "/" ? "text-[#c3d533]" : "text-white"
                    }`}
                  >
                    Home
                  </Link>
              ...
              {/* Divider */}
              <div className="w-full max-w-md mx-auto border-t border-gray-600 my-10" />
